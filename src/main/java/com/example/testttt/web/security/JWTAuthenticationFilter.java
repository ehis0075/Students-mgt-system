...
import static com.example.testttt.web.security.SecurityConstants.*;
        ...
        try {
            ...
            return authenticationManager.authenticate(
                    new UsernamePasswordAuthenticationToken(
                            // creds.isEnabled() // creds.getIsEnabled = true;
                            creds.getUsername(), //creds.getPrinciple() e.g username or email,
